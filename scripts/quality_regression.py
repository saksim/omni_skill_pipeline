...
DEFAULT_MANIFEST_PATH = REPO_ROOT / 'docs' / 'current' / 'status' / 'baselines' / 'e11-quality-regression-manifest.json'
DEFAULT_OUTPUT_PATH = REPO_ROOT / 'docs' / 'current' / 'status' / 'baselines' / 'e11-quality-regression-report.json'
