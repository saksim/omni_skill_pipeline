...
class ReleaseArtifactsScriptTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        (self.dist_dir / "omni_skill_pipeline-0.2.1-py3-none-any.whl").write_bytes(b"wheel-bytes")
    ...
    def test_builds_release_pack_with_manifest_summary_and_hashes(self) -> None:
        ...
        expected_files = {
            ...
            "omni_skill_pipeline-0.2.1-py3-none-any.whl",
        ...
        self.assertEqual(manifest["project"]["version"], "0.2.1")
