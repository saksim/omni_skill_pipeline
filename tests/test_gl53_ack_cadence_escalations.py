...
def _gl52_report(
    *,
    ...
    return {
        ...
        "followup_resolution_escalation_action_plan_closure_cadence_escalation_acknowledgement_closure_status_gl51": "ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_CLOSURE_PROGRESSING",
        "followup_resolution_escalation_action_plan_closure_cadence_escalation_acknowledgement_closure_cadence_status": status,
        "warning_codes": [],
        "followup_resolution_escalation_action_plan_closure_cadence_escalation_acknowledgement_closure_cadence_counts": {
            ...
            "net_new_closed_item_count_gl51": 0,
            "net_new_launch_gate_eligible_loop_count_gl51": 0,
        ...
        "followup_resolution_escalation_action_plan_closure_cadence_escalation_acknowledgement_closure_cadence_rows": rows,
    }
...
class RealTrialSubmissionQueueFollowupResolutionEscalationActionPlanClosureCadenceEscalationAcknowledgementClosureCadenceEscalationsScriptTests(
    ...
    def test_not_required_path(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            payload = json.loads(gl53.read_text(encoding="utf-8"))
            self.assertEqual(
                payload.get(
    ...
    def test_due_path_generates_due_escalation_rows(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual(
                ...
                "ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_CLOSURE_CADENCE_ESCALATION_DUE",
            )
            rows = payload.get(
            ...
            self.assertIn("acknowledgement_closure_cadence_due_escalation_required", warning_codes)
            ...
            _write_json(
                ...
                _gl52_report(
                    ...
                    rows=[
                        {
                            "acknowledgement_ingestion_item_id": "gl50-ack-ingestion-gl46-slot-001-text",
                            "closure_state_gl51": "open_carried",
                            "acknowledgement_ingestion_state_gl50": "ack_loop_mismatch",
                            "cadence_item_status": "refresh_due",
                            "required_modality_gl47": "text",
                            "owner_gl51": "controlled-beta-ops",
                            "action_id_gl48": "gl46-slot-001-text",
                            "linked_submission_loop_id_gl24": "real-text-001",
                            "next_refresh_due_utc_gl52": "2026-05-29T00:00:00Z",
                        }
                    ],
