...
SCRIPT_PATH = REPO_ROOT / "scripts" / "gl58_closure_cadence_escalation_closure_cadence.py"
...
def _gl57_report(*, status: str, generated_at_utc: str, rows: list[dict[str, Any]]) -> dict[str, Any]:
    open_count = sum(
    ...
    return {
        ...
        "followup_resolution_escalation_action_plan_closure_cadence_escalation_acknowledgement_closure_cadence_escalation_closure_cadence_escalation_status_gl56": "ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_CLOSURE_CADENCE_ESCALATION_CLOSURE_CADENCE_ESCALATION_MONITORING",
        "followup_resolution_escalation_action_plan_closure_cadence_escalation_acknowledgement_closure_cadence_escalation_closure_status_gl54": "ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_CLOSURE_CADENCE_ESCALATION_CLOSURE_PROGRESSING",
        ...
        "followup_resolution_escalation_action_plan_closure_cadence_escalation_acknowledgement_closure_cadence_escalation_closure_cadence_escalation_closure_counts": {
            ...
            "net_new_closed_without_gl54_net_new_closed_item_count": 0,
            "gl54_net_new_closed_item_count": 0,
            "gl54_net_new_closed_action_item_count": 0,
        },
...
class RealTrialSubmissionQueueFollowupResolutionEscalationActionPlanClosureCadenceEscalationAcknowledgementClosureCadenceEscalationClosureCadenceEscalationClosureCadenceScriptTests(
    unittest.TestCase
):
    def test_not_required_path(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            _write_json(
                gl57,
                _gl57_report(
                    status="ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_CLOSURE_CADENCE_ESCALATION_CLOSURE_CADENCE_ESCALATION_CLOSURE_NOT_REQUIRED",
            ...
            payload = json.loads(gl58.read_text(encoding="utf-8"))
            self.assertEqual(
                payload.get(
                ...
                "ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_CLOSURE_CADENCE_ESCALATION_CLOSURE_CADENCE_ESCALATION_CLOSURE_CADENCE_NOT_REQUIRED",
            )
    ...
    def test_due_path_from_previous_report(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            _write_json(
                gl57,
                _gl57_report(
                    status="ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_CLOSURE_CADENCE_ESCALATION_CLOSURE_CADENCE_ESCALATION_CLOSURE_PROGRESSING",
                    generated_at_utc="2026-05-31T00:00:00Z",
                    rows=[
                        {
                            "closure_item_id": "gl57-closure-cadence-escalation-closure-gl56-esc-001",
    ...
    def test_overdue_stalled_fail_on_requested(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            _write_json(
                gl57,
                _gl57_report(
                    status="ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_CLOSURE_CADENCE_ESCALATION_CLOSURE_CADENCE_ESCALATION_CLOSURE_STALLED",
                    generated_at_utc="2026-05-31T00:00:00Z",
                    rows=[
                        {
                            "closure_item_id": "gl57-closure-cadence-escalation-closure-gl56-esc-001",
