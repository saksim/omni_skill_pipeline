...
- `v0.2.6-internal.3` 是当前内部 dogfood 与自证闭环门禁发版候选边界。真实数据接入路径记录在 `real-data-intake-and-validation.md`；非基础设施加固路径记录在 `artifact-encryption.md`；Docker、Postgres、K8s 和 external real-loop gate 是独立门禁。
