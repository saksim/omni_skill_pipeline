...
- GL-50 acknowledgement-ingestion status: `ACTION_PLAN_CLOSURE_CADENCE_ESCALATION_ACK_INGESTION_ACTION_REQUIRED`
...
- Net-new closed backed by GL-50 closed ingestion items: `0`
...
## Open Closure Rows
- `gl54-ack-closure-cadence-escalation-closure-gl53-ack-closure-cadence-escalation-gl46-slot-001-text` state=net_new_open severity_gl53=on_schedule modality=text action=gl46-slot-001-text ack_state_gl50=ack_loop_mismatch
