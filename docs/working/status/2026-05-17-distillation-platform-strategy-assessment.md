...
> Sources: `src/`, `tests/`, `docs/latest/architecture/`, `docs/working/status/launch-readiness-master-plan.md`, public field references listed below
...
4. 在 `docs/working/status/baselines/` 建立固定 manifest。
