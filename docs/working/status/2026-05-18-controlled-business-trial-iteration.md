...
- Files: `docs/working/status/CURRENT_STATUS.md`, `README.md`, `docs/INDEX.md`
- Work:
...
- Files: `docs/working/status/baselines/`, optional `scripts/validate_manifest.py`, tests under `tests/`
- Work:
...
- Evidence:
  - Added template `docs/working/status/baselines/trial-manifests/trial-sample-manifest.template.json` with required fields: `modality`, `scenario`, `source_owner`, `sensitivity`, `asset_list`, `review_owner`, `target_package_format`, `expected_output_type`.
...
- Files: `src/omni_skill_pipeline/quality/`, `src/omni_skill_pipeline/service.py`, `docs/latest/operations/`
- Work:
...
- Evidence:
  ...
  - Documented enable/disable behavior in `docs/latest/operations/env.md`.
...
- Files: `scripts/`, `src/omni_skill_pipeline/quality/`, `docs/working/status/baselines/`, tests under `tests/`
- Work:
...
- Evidence:
  ...
  - Added baseline template `docs/working/status/baselines/trial-metrics/trial-metrics-manifest.template.json`.
  - Added focused tests:
...
- Files: `src/omni_skill_pipeline/models.py`, `docs/latest/architecture/`, tests under `tests/`
- Work:
...
- Evidence:
  ...
  - Added architecture doc `docs/latest/architecture/agent-skill-package-model.md` and linked it in:
    - `docs/latest/architecture/ARCHITECTURE.md`
    - `docs/INDEX.md`
...
- Evidence:
  ...
  - Added configurable line budget:
    ...
    - `.env.example` and `docs/latest/operations/env.md` updated
...
- Files: `src/omni_skill_pipeline/cli.py`, `src/omni_skill_pipeline/exporters/`, `docs/latest/operations/cli.md`, tests under `tests/`
- Work:
...
- Evidence:
  ...
  - Added CLI operation doc updates in `docs/latest/operations/cli.md` for `export-skill` usage and target mappings.
...
- Evidence:
  ...
  - Updated CLI docs `docs/latest/operations/cli.md` with validator usage and exit-code contract.
...
- Files: `examples/`, `docs/working/status/baselines/`, tests under `tests/`
- Work:
...
- Files: `scripts/controlled_trial.py`, `docs/latest/operations/runbooks/`, tests under `tests/`
- Work:
...
- Evidence:
  ...
  - Added runbook `docs/latest/operations/runbooks/controlled-trial-loop.md` and runbook index/baseline entry updates:
...
- Files: `docs/latest/operations/runbooks/`, optional `scripts/`
- Work:
...
- Evidence:
  - Added runbook `docs/latest/operations/runbooks/agent-smoke-protocol.md` with:
  ...
  - Added recorder script `scripts/agent_smoke.py`:
    ...
    - writes/updates report `docs/working/status/baselines/controlled-trial/agent-smoke-report.json`
...
- Files: `docs/working/status/baselines/`, `docs/working/status/`
- Work:
...
- Evidence:
  - Added final report template `docs/working/status/baselines/controlled-trial/controlled-trial-final-report.template.md` with:
  ...
  - Updated baseline index `docs/working/status/baselines/README.md` with CBT-14 entry and report-template path, so reviewers can locate the decision template from the baseline entry doc.
