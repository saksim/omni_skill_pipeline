...
- Total escalation items: `1`
- Open escalation items: `1`
...
## Escalation Rows
- `gl59-escalation-closure-cadence-escalation-closure-cadence-escalation-gl46-slot-001-text` severity=on_schedule cadence_item=on_schedule modality=text action=monitor_until_due
