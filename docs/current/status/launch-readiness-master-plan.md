...
| 缺 API 文档 | 不成立 | FastAPI docs 存在，仓内已有 `docs/current/operations/api.md` | 非阻断 |
...
- 文件：`scripts/`, `docs/current/operations/worker.md`, `docs/current/operations/env.md`
...
- 关联功能点：F31
- 目标：补 API 运维合同文档
- 文件：`docs/current/operations/api.md`, `docs/current/operations/env.md`
...
- 文件：`docs/current/operations/runbooks/launch-beta.md`
...
- 文件：`docs/current/status/baselines/`, `scripts/`
...
- 文件：`src/omni_skill_pipeline/retrieval/`, `docs/current/architecture/`
...
- 文件：`apps/`, `src/`, `docs/current/operations/`
